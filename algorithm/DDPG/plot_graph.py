...
def save_graph():
    ...
    # log_dir = "DDPG_logs/" + env_name + '/'
    log_dir = "TD3_logs/" + env_name + '/'

    # current_num_files = next(os.walk(log_dir))[2]
    # num_runs = len(current_num_files)
    # just read latest. log file
    # for run_num in range(num_runs - 1, num_runs):
    # log_f_name = log_dir + '/PPO_' + env_name + "_log_" + str(run_num) + ".csv"

    all_runs = []
    # log_f_name = log_dir + "DDPG_InvertedDoublePendulum-v4_log_20240107211209.csv"
    log_f_name = log_dir + "TD3_InvertedDoublePendulum-v4_log_20240108093024.csv"
